...
;To sort the list of integers in ascending/descending order using bubble sort. Read the input from the text file and write the sorted 
;data back to the same text file.
%include	"macro.asm"
