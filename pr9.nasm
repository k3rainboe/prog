...
;ges@ges-OptiPlex-3020:~$ ld fact.o -o fact
;ges@ges-OptiPlex-3020:~$ ./fact
;**Problem to find factorial of a number**
;Enter the number
;04
;Factorial is
;0000000000000018ges@ges-OptiPlex-3020:~$ ./fact
;**Problem to find factorial of a number**
;Enter the number
;02
;Factorial is
;0000000000000002ges@ges-OptiPlex-3020:~$ ./fact
;**Problem to find factorial of a number**
;Enter the number
;06
;Factorial is
;00000000000002D0ges@ges-OptiPlex-3020:~$ 
